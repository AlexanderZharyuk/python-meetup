    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name_conf', models.CharField(help_text='Название конференции', max_length=500, verbose_name='Название конференции')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tg_speaker_id', models.IntegerField(verbose_name='Телеграм-ID докладчика')),
                ('fullname', models.CharField(help_text='Введите имя и фамилию докладчика', max_length=100, verbose_name='Фамилия и имя докладчика')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tg_user_id', models.IntegerField(verbose_name='Телеграм-ID задающего вопрос')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('performance_name', models.CharField(max_length=100, verbose_name='Название выступления')),
                ('description', models.TextField(max_length=5000, verbose_name='Описание выступления')),
                ('time_performance', models.TimeField(help_text='Введите время выступления', verbose_name='Время выступления')),
